...
from messages.funcs.get_markup_default import get_markup_default, get_markup_default_main, \
    get_markup_default_location_cancel
from messages.funcs.get_markup_inline import get_markup_inline, get_markup_inline_delete
